...
export type ItemStatus = 'DRAFT' | 'PENDING_APPROVAL' | 'PUBLISHED' | 'ARCHIVED' | 'WITHDRAWN';

export type FoundationType = 'DEF' | 'GV' | 'LOV' | 'TEC' | 'SYS' | 'DM';
...
export const dynamicFoundationItems: FoundationItem[] = [
  {
    ...
    body: 'Classifies the risk level of a contract or component group for underwriting and pricing purposes. Values are drawn from the Risk Classification LOV and must be set during initial contract setup.',
    wolExpression: 'DM.RiskClassification := LOV.RiskClasses[status = "active"]',
  },
  {
    id: 'dm-002',
    name: 'Broker Channel',
    ...
    usages: 6,
    dmType: 'single-select',
    dmApplicability: ['contract'],
    body: 'Identifies the broker distribution channel for reporting, commission handling, and downstream analytics segmentation.',
    wolExpression: 'DM.BrokerChannel := LOV.BrokerChannels[isActive = true]',
  },
  {
    id: 'dm-003',
    ...
    body: 'Indicates whether sanctions screening evidence is mandatory before binding or endorsement issuance.',
    wolExpression: 'DM.SanctionsScreeningRequired := if(Contract.Jurisdiction in ["UK","EU"], true, false)',
  },
  {
    id: 'dm-004',
    name: 'Portfolio Segment Tags',
    type: 'DM',
    status: 'DRAFT',
    version: '0.3.0',
    ...
    body: 'Supports multi-tag classification of portfolio segments for search, governance and approval routing.',
    wolExpression: 'DM.PortfolioSegmentTags := LOV.PortfolioSegments[isEnabled = true]',
  },
];
...
export const repositoryItems: RepositoryItem[] = [
  { id: 'ctr-001', name: 'LMA5400 Marine Hull Policy', type: 'Contract', status: 'PUBLISHED', classOfBusiness: 'Marine Hull', version: '3.2.0', lastModified: '2026-03-08', owner: 'R. Pyke', jurisdiction: 'UK', description: 'Standard marine hull policy wording for London Market.', usedIn: [] },
  { id: 'cg-001', name: 'Marine Perils Group', type: 'Component-Group', status: 'PUBLISHED', classOfBusiness: 'Marine Hull', version: '4.0.0', lastModified: '2026-03-07', owner: 'R. Pyke', jurisdiction: 'UK', description: 'Group of marine peril components including standard and war risks.', usedIn: ['ctr-001'] },
  { id: 'cmp-002', name: 'C Notice of non-renewal', type: 'Component', status: 'DRAFT', classOfBusiness: 'Marine Hull', version: '0.1.0', lastModified: '2026-03-30', owner: 'R. Pyke', jurisdiction: 'UK', description: '', usedIn: [], format: 'digital' },
  ...
  { id: 'cmp-003', name: 'C Sanctions Compliance Warranty', type: 'Component', status: 'PUBLISHED', classOfBusiness: 'Marine Hull', version: '2.0.0', lastModified: '2026-03-11', owner: 'R. Pyke', jurisdiction: 'UK', description: 'Warranty requiring sanctions compliance checks before attachment.', usedIn: ['cg-001', 'ctr-001'], format: 'digital' },
  ...
  { id: 'cl-001', name: '12.8 Cancellation Terms', type: 'Component', status: 'PUBLISHED', classOfBusiness: 'Marine Hull', version: '1.7.0', lastModified: '2026-02-26', owner: 'R. Pyke', jurisdiction: 'UK', description: 'Clause text governing cancellation rights and notice periods.', usedIn: ['cmp-002'], format: 'digital' },
  { id: 'doc-001', name: 'ITC Hulls 10/83 Reference PDF', type: 'Component', status: 'PUBLISHED', classOfBusiness: 'Marine Hull', version: '5.1.0', lastModified: '2026-01-10', owner: 'C. Wise', jurisdiction: 'UK', description: 'Reference analogue wording source document.', usedIn: ['ctr-001'], format: 'digital' },
  ...
  { id: 'cmp-005', name: 'C Claims Cooperation Clause', type: 'Component', status: 'PUBLISHED', classOfBusiness: 'Marine Hull', version: '1.3.0', lastModified: '2026-03-22', owner: 'R. Pyke', jurisdiction: 'UK', description: 'Obligations for assured cooperation during claims handling and investigation.', usedIn: ['cg-001', 'ctr-001'], format: 'digital' },
  { id: 'cmp-006', name: 'C Prompt Notice of Loss', type: 'Component', status: 'PUBLISHED', classOfBusiness: 'Marine Hull', version: '1.2.0', lastModified: '2026-03-20', owner: 'A. Lloyd', jurisdiction: 'UK', description: 'Sets timing requirements for notifying underwriters of loss events.', usedIn: ['cg-001', 'ctr-001'], format: 'digital' },
  ...
  { id: 'cmp-008', name: 'C Sue and Labour Expenses', type: 'Component', status: 'PUBLISHED', classOfBusiness: 'Marine Hull', version: '2.1.0', lastModified: '2026-03-18', owner: 'R. Pyke', jurisdiction: 'UK', description: 'Recovery terms for sue and labour charges incurred to avert loss.', usedIn: ['cg-001', 'ctr-001'], format: 'digital' },
  ...
  { id: 'cmp-010', name: 'C Partial Loss Settlement Basis', type: 'Component', status: 'PUBLISHED', classOfBusiness: 'Marine Hull', version: '1.6.0', lastModified: '2026-03-16', owner: 'R. Pyke', jurisdiction: 'UK', description: 'Establishes valuation basis for partial loss and repair settlements.', usedIn: ['cg-001', 'ctr-001'], format: 'digital' },
  { id: 'cmp-011', name: 'C General Average Contribution', type: 'Component', status: 'PUBLISHED', classOfBusiness: 'Marine Cargo', version: '1.1.0', lastModified: '2026-03-23', owner: 'C. Wise', jurisdiction: 'UK', description: 'General average and salvage contribution treatment for cargo interests.', usedIn: ['cg-002', 'ctr-002'], format: 'digital' },
  ...
  { id: 'cmp-013', name: 'C Warehouse-to-Warehouse Scope', type: 'Component', status: 'PUBLISHED', classOfBusiness: 'Marine Cargo', version: '2.0.0', lastModified: '2026-03-14', owner: 'R. Pyke', jurisdiction: 'UK', description: 'Defines warehouse-to-warehouse attachment and termination points.', usedIn: ['cg-002', 'ctr-002'], format: 'digital' },
  ...
  { id: 'cmp-015', name: 'C Pair and Set Limitation', type: 'Component', status: 'PUBLISHED', classOfBusiness: 'Marine Cargo', version: '1.4.0', lastModified: '2026-03-13', owner: 'R. Pyke', jurisdiction: 'UK', description: 'Limits recovery for partial damage to matched pairs or sets.', usedIn: ['cg-002', 'ctr-002'], format: 'digital' },
  { id: 'cmp-016', name: 'C Accumulation Control Endorsement', type: 'Component', status: 'DRAFT', classOfBusiness: 'Property', version: '0.2.0', lastModified: '2026-03-30', owner: 'A. Lloyd', jurisdiction: 'UK', description: 'Draft accumulation controls for concentration exposure management.', usedIn: [], format: 'digital' },
  { id: 'cmp-017', name: 'C Catastrophe Event Definition', type: 'Component', status: 'PUBLISHED', classOfBusiness: 'Property', version: '1.0.0', lastModified: '2026-03-21', owner: 'C. Wise', jurisdiction: 'UK', description: 'Defines catastrophe event boundaries for aggregation and deductible.', usedIn: [], format: 'digital' },
  { id: 'cmp-018', name: 'C Cyber Carve-Out Clarification', type: 'Component', status: 'PUBLISHED', classOfBusiness: 'Casualty', version: '1.5.0', lastModified: '2026-03-19', owner: 'R. Pyke', jurisdiction: 'UK', description: 'Clarifies cyber exclusion carve-backs for accidental non-malicious events.', usedIn: [], format: 'digital' },
  { id: 'cmp-019', name: 'C Named Insured Amendment', type: 'Component', status: 'PENDING_APPROVAL', classOfBusiness: 'Casualty', version: '0.7.0', lastModified: '2026-03-28', owner: 'A. Lloyd', jurisdiction: 'UK', description: 'Amends named insured schedule and affiliate coverage provisions.', usedIn: [], format: 'digital' },
  { id: 'cmp-020', name: 'C War Risks Buy-Back Conditions', type: 'Component', status: 'PUBLISHED', classOfBusiness: 'Marine Hull', version: '1.9.0', lastModified: '2026-03-12', owner: 'R. Pyke', jurisdiction: 'UK', description: 'Conditions and pricing hooks for war risks buy-back options.', usedIn: ['cg-001', 'ctr-001'], format: 'digital' },
  ...
  { id: 'cmp-022', name: 'C Crew Competency Warranty', type: 'Component', status: 'PUBLISHED', classOfBusiness: 'Marine Hull', version: '1.1.0', lastModified: '2026-03-15', owner: 'A. Lloyd', jurisdiction: 'UK', description: 'Requires minimum competency and certification standards for crew.', usedIn: ['cg-001'], format: 'digital' },
