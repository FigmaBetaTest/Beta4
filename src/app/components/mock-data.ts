...
export const foundationItems: FoundationItem[] = [
  ...
  },
  {
    ...
    usages: 4,
    format: 'analogue',
    summary: 'Specifies how optional clauses are rendered in analogue policy outputs. Includes rules for shaded left-bar indicators and optional-block exclusions.',
    linkedUsages: [],
    usedIn: ['ctr-001'],
  },
  {
    id: 'tec-002',
    name: 'Coverholder Appointment Language',
    type: 'TEC',
    status: 'DRAFT',
    version: '0.3.0',
    ...
    usages: 0,
    format: 'digital',
    summary: 'Standard wording guidance for coverholder appointment clauses, outlining required authority limits, reporting obligations, and termination provisions for use by legal reviewers.',
    linkedUsages: [],
    usedIn: [],
  },
  {
  ...
  {
    id: 'sys-002',
    name: 'Notice Days Variable — Processing Note',
    type: 'SYS',
    status: 'ACTIVE',
    version: '1.0.0',
    ...
    usages: 1,
    format: 'digital',
    summary: 'This variable holds the number of business days required for written notice. It should only be used in clauses where notice is delivered in writing to the registered address. Do not use for electronic notice provisions.',
    linkedUsages: [],
    usedIn: ['gv-001'],
  },
];
