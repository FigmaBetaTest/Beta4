                ...
                {paragraph.blockType === 'label' ? (
                  ...
                  <div className="flex items-start gap-2" style={paragraph.indent ? { paddingLeft: `${paragraph.indent * 48}px` } : {}}>
                    ...
                    <AutoResizeTextarea
                      ...
                      style={{ fontFamily: "'DM Sans', sans-serif", fontSize: '13px', fontWeight: 600, color: '#C5143D', minHeight: '20px' }}
                    />
                  </div>
                    ...
                    <div className="flex-1">
                      {paragraph.titlePrefix && (
                        <div
                          ...
                          style={{ fontFamily: "'DM Sans', sans-serif", fontSize: '11px', fontWeight: 600, color: '#9ca3af', letterSpacing: '0.04em', marginBottom: '2px', userSelect: 'none' }}
                        >
                          {paragraph.titlePrefix}
                        </div>
                      )}
                      <AutoResizeTextarea
                        ...
                        placeholder="Heading..."
                        style={{ fontFamily: "'DM Sans', sans-serif", fontSize: '18px', fontWeight: 700, color: '#1F1F1F', minHeight: '28px' }}
                      />
                    </div>
                  </div>
                  ...
                  <div className="flex items-start gap-2" style={paragraph.indent ? { paddingLeft: `${paragraph.indent * 48}px` } : {}}>
                    ...
                    <AutoResizeTextarea
                      ...
                      onChange={(val) => onUpdateParagraph(paragraph.id, val)}
                      placeholder="Heading..."
                      style={{ fontFamily: "'DM Sans', sans-serif", fontSize: '15px', fontWeight: 700, color: '#1F1F1F', minHeight: '24px' }}
                    />
                  </div>
                      ...
                      >
                        <div className="relative shrink-0" style={{ width: `${Math.max(56, (paragraph.clauseNumber ?? '').length * 7.5)}px` }}>
                          <input
                            ...
                            style={{ fontFamily: "'DM Sans', sans-serif", paddingTop: '2px' }}
                            placeholder="12.34"
                            onFocus={() => setFocusedParagraphId(paragraph.id)}
                            onKeyDown={(e) => {
                        ...
                        <AutoResizeTextarea
                          ...
                          style={{ fontFamily: "'DM Sans', sans-serif", minHeight: '28px' }}
                        />
                      </div>
                    </div>
                    {paragraph.variants?.map((variant) => (
                      <div key={`${paragraph.id}-${variant.letter}`} className="group/paragraph flex items-start">
                        ...
                        <div className="flex items-start flex-1" style={{ paddingLeft: `${(paragraph.indent ?? 0) * 68 + 8}px` }}>
                          <span className="text-[14px] text-[#374151] shrink-0" style={{ fontFamily: "'DM Sans', sans-serif", width: `${Math.max(56, (paragraph.clauseNumber ?? '').length * 7.5)}px`, minWidth: `${Math.max(56, (paragraph.clauseNumber ?? '').length * 7.5)}px`, paddingTop: '2px', display: 'inline-block' }}>{paragraph.clauseNumber ?? ''}</span>
                  ...
                  <div className="flex items-start gap-2">
                    ...
                    <div className="flex-1 border-l-2 border-[#C5143D] bg-[#FFF8F8] px-3 py-2">
                      ...
                      <AutoResizeTextarea
                        ...
                        style={{ fontFamily: "'DM Sans', sans-serif", fontSize: '13px', color: '#374151', minHeight: '20px' }}
                        onFocus={() => setFocusedParagraphId(paragraph.id)}
                  ...
                  <>
                    ...
                    >
                      ...
                      <AutoResizeTextarea
                        ...
                        style={{ fontFamily: "'DM Sans', sans-serif", minHeight: '28px', textAlign: paragraph.textAlign ?? 'left' }}
                      />
                    </div>
                    {/* Variant B, C, D, etc. */}
                    {paragraph.variants?.map((variant) => (
            ...
            <div className="max-w-[700px] mx-auto space-y-4">
              {paragraphs.map((paragraph, pIdx) => {
                ...
                <div key={`preview-${paragraph.id}`} className="space-y-2" style={tightSpacing ? { marginTop: '4px' } : {}}>
                  {paragraph.blockType === 'label' ? (
                    <p style={{ fontFamily: "'DM Sans', sans-serif", fontSize: '13px', fontWeight: 600, color: '#C5143D', margin: 0 }}>
                      {paragraph.content}
                    </p>
                  ) : paragraph.blockType === 'h1' ? (
                    <div>
                      {paragraph.titlePrefix && (
                        <div style={{ fontFamily: "'DM Sans', sans-serif", fontSize: '11px', fontWeight: 600, color: '#9ca3af', letterSpacing: '0.04em', marginBottom: '2px' }}>
                          {paragraph.titlePrefix}
                        </div>
                      )}
                      <h1 style={{ fontFamily: "'DM Sans', sans-serif", fontSize: '18px', fontWeight: 700, color: '#1F1F1F', margin: 0 }}>
                        {paragraph.titlePrefix ? paragraph.content.replace(new RegExp(`^${paragraph.titlePrefix}\\s*`), '') : paragraph.content}
                      </h1>
                    </div>
                  ) : paragraph.blockType === 'h2' ? (
                    <h2 style={{ fontFamily: "'DM Sans', sans-serif", fontSize: '15px', fontWeight: 700, color: '#1F1F1F', margin: 0 }}>
                      {paragraph.content}
                    </h2>
                  ) : paragraph.blockType === 'sub-component-title' ? (
                    <div className="mt-4">
                      <div style={{ fontFamily: "'DM Sans', sans-serif", fontSize: '11px', fontWeight: 600, color: '#9ca3af', letterSpacing: '0.04em', marginBottom: '2px' }}>SC</div>
                      <h2 style={{ fontFamily: "'DM Sans', sans-serif", fontSize: '15px', fontWeight: 700, color: '#1F1F1F', margin: 0 }}>
                    ...
                    <>
                      ...
                      >
                        <span
                          ...
                          style={{ fontFamily: "'DM Sans', sans-serif", width: `${Math.max(56, (paragraph.clauseNumber ?? '').length * 7.5)}px`, minWidth: `${Math.max(56, (paragraph.clauseNumber ?? '').length * 7.5)}px` }}
                        >
